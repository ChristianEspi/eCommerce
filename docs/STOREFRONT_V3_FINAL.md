...
| P14 | PASS | *(este commit)* | Auditoría funcional, multi-industria, accesibilidad, responsive y seguridad. Dos defectos reales encontrados y corregidos. |
...
| **HEAD final** | ver `git log -1` tras el commit de P14 |
